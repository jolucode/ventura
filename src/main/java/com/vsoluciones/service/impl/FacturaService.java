...
public class FacturaService {
    ...
    public void procesarFactura(Factura factura) {
        // Aquí puedes implementar la lógica de procesamiento de la factura
        //System.out.println("Procesando la factura de la empresa: " + factura.getEmpresa().getRazonSocial());
    ...
    public String generateTaxTotal(Factura factura) {
        StringBuilder xml = new StringBuilder();
